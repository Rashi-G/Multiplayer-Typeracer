...
float ispeed;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(230, 220, 160, 30);
        ...
        setBounds((screenSize.width-607)/2, (screenSize.height-366)/2, 607, 366);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        HomePage obj2=new HomePage(user);
      ...
      // Enter was pressed. Your code goes here.
        ...
        char ch = evt.getKeyChar();
            ...
            Logger.getLogger(login.class.getName()).log(Level.SEVERE, null, ex);
                   ...
                   try {
            Connection con  =   (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3307/softa","root","20inaheg08");
                  String q = "insert into records (username,avracc,avrspeed,lastspeed) values (?,?,?,?)";
